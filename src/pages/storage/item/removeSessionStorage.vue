<template>
  <div class="item_method">
    <div class="item_head">根据key删除sessionStorage--removeSessionStorage</div>
    <div class="item_title">说明：</div>
    <div class="item_detail">
      <div class="detail_title">参数：</div>
      <div class="detail_contain">key：String类型，sessionStorage的键</div>
    ...
    <div class="item_detail">
      ...
      <div class="form_btn">
        <a-button @click="getResultBtn" type="primary">删除</a-button>
      </div>
...
export default {
  ...
  methods: {
    getResultBtn() {
      ...
      this.result = getSessionStorage(key) ? '失败' : '成功';
    }
  },
  computed: {
  }
