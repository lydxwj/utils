<template>
  <div class="item_method">
    <div class="item_head">设置localStorage--setLocalStorage</div>
...
<script>
import { setLocalStorage, getLocalStorage, evil } from '@/utils';
export default {
  data () {
    return {
      key: '',
  ...
  methods: {
    getResultBtn() {
      ...
      setLocalStorage(key, evil(value));
      this.result = getLocalStorage(key);
    }
  },
  computed: {
  }
